      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="rounded-2xl border border-[#DCE8E9] bg-white p-6 h-fit">
          ...
          <div className="space-y-3">
            ...
            <Button onClick={add} disabled={saving} className="w-full bg-[#0B7C8C] hover:bg-[#075F6C] text-[#F4F9F9]">
        ...
        <div className="lg:col-span-2 rounded-2xl border border-[#DCE8E9] bg-white p-6">
          ...
          {facilities.length === 0 && <div className="text-sm text-[#5A6B70]">No facilities yet. Add your first one.</div>}
